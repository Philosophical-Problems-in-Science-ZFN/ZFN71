...
\input{ART_Wysocki/wysocki.tex} %AC
\input{ART_Polak/polak.tex}
\input{ART_Gorazda/gorazda.tex} %AC
\input{ART_Zaluski/zaluski.tex} %AC
...
%polskie
\input{REV_Gradzka/gradzka.tex}
\input{REV_Mscislawski/mscislaw.tex}
\input{REV_Krzanowski/krzanowski.tex} %AC


%angielski
\input{REV_Szybka/szybka.tex}
\input{REV_Polak/polak.tex}
\input{REV_Piechowicz/piechowicz.tex} %AC
\input{REV_Cygan/cygan.tex} %AC
\input{REV_Borek/borek.tex}
